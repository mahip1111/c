...
// ANS:- see ags apna 2 if use kiya and wo dono sahi hai then in that case wo dono chalenga but agr apna 1 if and 1 else if use kiya then koi ek hi chalega. You can observe it by cahnging any one of else if by if in above code.
